...
(*** condition: prepare ***)
#nowarn "211"
#r "../src/RProvider/bin/Release/net8.0/RDotNet.dll"
#r "../src/RProvider/bin/Release/net8.0/RDotNet.FSharp.dll"
#r "../src/RProvider/bin/Release/net8.0/RProvider.Runtime.dll"
#r "../src/RProvider/bin/Release/net8.0/RProvider.DesignTime.dll"
#r "../src/RProvider/bin/Release/net8.0/RProvider.dll"
(*** condition: fsx ***)
#if FSX
